...
export default function Service() {
    return(
        <section id="service">
            <div className="my-5 flex flex-col justify-center items-center bg-[url(src/assets/serviceBg.jpg)]
            bg-cover bg-no-repeat">
                ...
                <div className="grid grid-cols-3 grid-rows-2 gap-4 mt-2 p-5">
                    <div className="p-5 rounded-xl flex flex-col items-center w-100 h-fit">
                        <div className="bg-zinc-100 text-center p-2 rounded-4xl text-2xl"><CgWebsite /></div>
                    ...
                    <div className="p-5 rounded-xl flex flex-col items-center w-100 h-fit">
                        <div className="bg-zinc-400 text-center p-2 rounded-4xl text-2xl"><MdOutlineDesignServices /></div>
                    ...
                    <div className="p-5 rounded-xl flex flex-col items-center w-100 h-fit">
                        <div className="bg-zinc-400 text-center p-2 rounded-4xl text-2xl"><IoPhonePortraitOutline /></div>
                    ...
                    <div className="p-5 rounded-xl flex flex-col items-center w-100 h-fit">
                        <div className="bg-zinc-400 text-center p-2 rounded-4xl text-2xl"><IoIosCloudOutline /></div>
                    ...
                    <div className="p-5 rounded-xl flex flex-col items-center w-100 h-fit">
                        <div className="bg-zinc-100 text-center p-2 rounded-4xl text-2xl"><PiBlueprintLight /></div>
                    ...
                    <div className="p-5 rounded-xl flex flex-col items-center w-100 h-fit">
                        <div className="bg-zinc-400 text-center p-2 rounded-4xl text-2xl"><FiDatabase /></div>
