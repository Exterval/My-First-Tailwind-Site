export default function Main() {
    return(
        <section id="main">
            <div className="bg-linear-to-r from-zinc-200 to-zinc-500 w-screen flex  justify-center items-center p-5 flex-col md:flex-row lg:flex-row">
                ...
                <div className="m-5 md:w-200">
                    <img src="src/assets/placeholder.jpg" alt="Image" className="w-full h-full shadow-sm" />
                </div>
            </div> 
        </section>
    )
