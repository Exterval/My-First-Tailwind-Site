export default function Main() {
    return(
        <section id="main">
            <div className="bg-linear-to-r from-zinc-200 to-zinc-500 w-full flex flex-col justify-center my-4" style={{height: '450px'}}>
                ...
                <div className="mx-auto flex flex-row">
                    ...
                    <button className="bg-white text-black p-4 rounded-2xl hover:bg-black hover:text-white hover:-translate-y-1 hover:shadow-2xs cursor-pointer
                    transition-all duration-300 ease-out border-white" id="">Sample text</button>
                </div>
            </div> 
        </section>
    )
